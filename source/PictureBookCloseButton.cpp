...
namespace NrvPictureBookCloseButton {
    FULL_NERVE(PictureBookCloseButtonNrvSelect, PictureBookCloseButton, Select);
    FULL_NERVE(PictureBookCloseButtonNrvSelected, PictureBookCloseButton, Selected);
    FULL_NERVE(PictureBookCloseButtonNrvNotSelected, PictureBookCloseButton, NotSelected);
};
...
bool PictureBookCloseButton::trySelect() {
    if (mPaneCtrl->trySelect()) {
        ...
        MR::startCSSound("CS_CLICK_CLOSE", nullptr, 0, 0, 0);
